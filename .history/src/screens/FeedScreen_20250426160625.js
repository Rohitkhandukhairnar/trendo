    ...
    <SafeAreaView
      ...
      <View
        ...
        <View style={styles.themeSwitchContainer}>
          <Image source={{uri:isDark?'https://cdn-icons-png.flaticon.com/128/702/702471.png':'https://cdn-icons-png.flaticon.com/128/66/66275.png'}} style={{width:20,height:20,marginRight:10,tintColor:theme.text}}/>
          <Switch
            value={isDark}
