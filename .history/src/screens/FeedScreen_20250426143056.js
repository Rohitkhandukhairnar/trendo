...
const NewsListScreen = ({ navigation ,route}) => {
  ...
  const userData = <route className="params"></route>.userData || {}; 
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        {/* <Image
          ...
          style={{ width: 50, height: 50, borderRadius: 25, marginBottom: 20 }}
        />
       <Text style={[styles.drawerTitle, { color: theme.primary }]}>Welcome, {userData?.email}</Text> */}
