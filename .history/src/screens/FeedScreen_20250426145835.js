...
const NewsListScreen = ({ navigation ,route}) => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        <TouchableOpacity activeOpacity={0.8} onPress={navigation.replacr('Profile')} >
        ...
        <Image 
          ...
          style={{   width: 90,
            ...
            alignSelf:'center',
            borderRadius: 50,
            marginBottom: 20,backgroundColor: theme.primary }}
            />
        <Text style={[styles.userDataText,{color:theme.text}]}> {userData.displayName}</Text>
        <Text style={[styles.userDataText,{color:theme.text}]}>{userData.email}</Text>
            </TouchableOpacity>
