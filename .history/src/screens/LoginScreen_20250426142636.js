...
GoogleSignin.configure({
  webClientId:
    '365440365934-cb6jmg9nu340vmmt9avl6h3mpc4epo87.apps.googleusercontent.com', // Get from google console Console -> credential
});
...
const FirebaseLoginScreen = ({navigation}) => {
  ...
  if (userData) {
    const 
    return ( navigation.replace('FeedScreen', { userData: userData })
