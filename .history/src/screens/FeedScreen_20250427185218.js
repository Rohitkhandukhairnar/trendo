...
import au {getAuth} from '@react-native-firebase/auth';
...
const NewsListScreen = ({navigation, route}) => {
  ...
  useEffect(() => { // Update local state
    const updatedDoc =  firestore().collection('users').doc(user.uid).get();
    setUserData(updatedDoc.data());
  }, []);
      ...
      <View
        ...
        <View style={styles.themeSwitchContainer}>
          <Image
            source={{
              uri: isDark
                ? 'https://cdn-icons-png.flaticon.com/128/702/702471.png'
                : 'https://cdn-icons-png.flaticon.com/128/10485/10485313.png',
            }}
            style={{
              width: 20,
              height: 20,
