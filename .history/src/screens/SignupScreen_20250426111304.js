...
const FirebaseSignUpScreen = ({navigation}) => {
  ...
  const passwordRef = useRef(null);
   ...
   const EMAIL_REGEX = /^[a-zA-Z0-9]+([.][a-zA-Z0-9]+)*@(gmail|yahoo|hotmail|outlook|icloud|aol|live|zoho)\.(com|org|in|edu)$/;
  ...
  return (
    <ScrollView style={{backgroundColor: 'white'}}>
      <View style={{flex: 1, padding: 0, justifyContent: 'flex-start'}}>
        <LottieView
          source={require('../assets/animation/signupbg.json')}
          resizeMode="cover"
          style={{
            width: '100%',
        ...
        <KeyboardAvoidingView
          ...
          <View style={styles.innerContainer}>
            <Text style={styles.title}>Create Account</Text>
                ...
                {loading && (
                  <ActivityIndicator style={{ position: 'absolute', width: 100,alignSelf: 'center',
                    height: 100,}} size={'large'} color={'#ff8400'} />
                )}


            <View style={styles.inputContainer}>
              <Image
                source={{uri: 'https://cdn-icons-png.flaticon.com/128/126/126486.png'}} 
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.replace('FirebaseLoginScreen')}>
